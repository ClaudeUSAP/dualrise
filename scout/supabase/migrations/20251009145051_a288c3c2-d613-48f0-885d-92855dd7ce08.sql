-- Update the calculate_scoring_avg_vs_cr_dynamic function to sort by actual tournament dates
...
BEGIN
  ...
  ELSIF filter_type = 'last_n' THEN
    -- Get last N tournaments (order by actual tournament dates, not creation time)
    SELECT 
