-- Add Last 3 columns to athletes table
ALTER TABLE athletes 
ADD COLUMN IF NOT EXISTS scoring_avg_last_3_raw TEXT,
ADD COLUMN IF NOT EXISTS scoring_avg_vs_par_last_3 TEXT,
ADD COLUMN IF NOT EXISTS scoring_avg_vs_cr_last_3 TEXT;

-- Update the athlete statistics cache function to include Last 3 calculations
...
BEGIN
  ...
  -- Calculate all VS CR periods (including Last 3)
  ...
  -- Update cached columns in athletes table (including Last 3)
  UPDATE athletes SET
    -- VS CR columns
