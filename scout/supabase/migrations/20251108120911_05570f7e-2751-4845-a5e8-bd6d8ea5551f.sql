-- Add missing scoring_avg_vs_cr_last_7 column
ALTER TABLE athletes ADD COLUMN IF NOT EXISTS scoring_avg_vs_cr_last_7 TEXT;

-- Update the cache function to include Last 7 vs CR calculation
...
-- Recalculate statistics for all athletes
DO $$
DECLARE
