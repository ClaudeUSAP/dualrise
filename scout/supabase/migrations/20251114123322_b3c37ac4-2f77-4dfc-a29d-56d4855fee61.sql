-- Update calculate_scoring_avg_dynamic to include import_order fallback
...
-- Update calculate_scoring_avg_vs_cr_dynamic to include import_order fallback
...
-- Update calculate_scoring_avg_vs_par_dynamic to include import_order fallback
